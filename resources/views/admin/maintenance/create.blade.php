                ...
                <div class="card shadow border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <h4 class="mb-4 fw-bold text-primary">
                            <i class="bi bi-tools"></i> {{ $title ?? 'Tambah Maintenance' }}
                        </h4>
                        ...
                        <form action="{{ route('maintenance.store') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="maintenance_type" class="form-control rounded-3" required>
                                        ...
                                        <option value="preventive"
                                            {{ old('maintenance_type') == 'preventive' ? 'selected' : '' }}>
                                            Preventive (Pencegahan)
                                        </option>
                                        <option value="corrective"
                                            {{ old('maintenance_type') == 'corrective' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="cost" class="form-control rounded-3"
                                        value="{{ old('cost') }}" placeholder="0" min="0" step="1000">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" class="form-control rounded-3" rows="3"
                                        placeholder="Jelaskan pekerjaan maintenance yang dilakukan...">{{ old('description') }}</textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="notes" class="form-control rounded-3" rows="2"
                                        placeholder="Catatan penting, kondisi mesin, dll...">{{ old('notes') }}</textarea>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-5">
                                ...
                                <button type="submit" class="btn btn-success px-5">
                                    <i class="bi bi-save"></i> Simpan Maintenance
                                </button>
                            </div>
